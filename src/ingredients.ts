...
export type PurchasePayment = { id: string; date: string; amount: number; note?: string }
export type IngredientPurchase = {
  id: string; date: string; shop: string; items: IngredientItem[]; photo?: string; archived?: boolean
  paymentStatus?: 'paid' | 'pending'; paidAmount?: number; payments?: PurchasePayment[]; creditor?: string; dueDate?: string; note?: string; paidAt?: string
}
